"""
Django settings for gift_tracker project.
...
SECRET_KEY = 'django-insecure-#ef@%a*e$)gm00p$n%keyy9%x@&!5@&5_*7_*0ny^nx0dcf%^='
...
WENMO_TIANJI_API_URL = os.environ.get('WENMO_TIANJI_API_URL', '')
WENMO_TIANJI_API_KEY = os.environ.get('WENMO_TIANJI_API_KEY', '')
